[![Gitlab Status](https://gitlab.com/gdraheim/git_fast_import_merge/badges/main/pipeline.svg?key_width=120&key_text=gitlab+pipeline)](https://gitlab.com/gdraheim/git_fast_import_merge)
